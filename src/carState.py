...
class CarState(object):
    ...
    def getRevState(self):
        temp = [self.angle, self.curLapTime, self.damage, self.distFromStart, self.lastLapTime, self.speedX, self.speedY, self.speedZ, self.trackPos, self.z]
        return temp+self.track
